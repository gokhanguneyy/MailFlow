...
using MailFlow.Business;
using MailFlow.Models;
using MailFlow.Options;
using MailFlow.Services;
using MailFlow.Validators;
...
builder.Services.AddMailFlowBusiness(
...
await app.Services.MigrateMailFlowDatabaseAsync();
